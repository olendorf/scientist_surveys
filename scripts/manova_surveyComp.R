...
### ANOVA
s_anova_two_way <- aov(dim_1 ~ survey_label*`10_32_19_2`, data = surveys_combined_demos_limited)
s_anova_two_way <- formattable(data.frame(unclass(summary(s_anova_two_way)), 
                                          check.names = FALSE, stringsAsFactors = FALSE))
s_anova_two_way_lm <- lm(dim_1 ~ work_sector, data = surveys_combined_demos_limited)
...
s_mean_sd <- na.omit(surveys_combined_demos_limited) %>%
  group_by(survey_label,`10_32_19_2`) %>%
...
### Boxplot
s_boxplot <- ggplot(na.omit(subset(surveys_combined_demos_limited)), 
...
### ANOVA
ws_anova_two_way <- aov(dim_1 ~ work_sector*survey_label, data = na.omit(subset(surveys_combined_demos_limited,survey_label!="S2")))
ws_anova_two_way <- formattable(data.frame(unclass(summary(ws_anova_two_way)), check.names = FALSE, stringsAsFactors = FALSE))
ws_anova_two_way_lm <- lm(dim_1 ~ work_sector, data = na.omit(subset(surveys_combined_demos_limited,survey_label!="S2")))
summary(ws_anova_two_way_lm)
summary(ws_anova_two_way_lm)
TukeyHSD(ws_anova_two_way)
...
### ANOVA
domain_anova_two_way <- aov(dim_1 ~ domain, data = surveys_combined_demos_limited)
domain_anova_two_way <- formattable(data.frame(unclass(summary(domain_anova_two_way)), 
                                               check.names = FALSE, stringsAsFactors = FALSE))
...
### ANOVA
fa_anova_two_way <- aov(dim_1 ~ funding_agency, data = surveys_combined_demos_limited)
fa_anova_two_way <- formattable(data.frame(unclass(summary(fa_anova_two_way)), 
                                           check.names = FALSE, stringsAsFactors = FALSE))
...
### ANOVA
region_anova_two_way <- aov(dim_1 ~ region, data = surveys_combined_demos_limited)
region_anova_two_way <- formattable(data.frame(unclass(summary(region_anova_two_way)), 
                                               check.names = FALSE, stringsAsFactors = FALSE))
