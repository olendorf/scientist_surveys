...
# Survey 3
nrow(subset(surveys_combined_demos,survey_label=="2020"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & region=="AfricaMENA"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & region=="AsiaSEAsia"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & region=="AustraliaNZ"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & region=="EuroRussia"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & region=="LatinAmerica"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & region=="USACanada"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & domain=="Natural science"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & domain=="Physical science"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & domain=="Information science"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & domain=="Social science"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & domain=="Other"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & work_sector=="Academic"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & work_sector=="Commercial"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & work_sector=="Government"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & work_sector=="Non-Profit"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & work_sector=="Other"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & funding_agency_recoded=="Corporation"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & funding_agency_recoded=="Federal/national gov."))
nrow(subset(surveys_combined_demos,survey_label=="2020" & funding_agency_recoded=="Private foundation"))
nrow(subset(surveys_combined_demos,survey_label=="2020" & funding_agency_recoded=="State/regional/local gov."))
nrow(subset(surveys_combined_demos,survey_label=="2020" & funding_agency_recoded=="Other"))
